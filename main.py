...
def evaluate_mode(validation_generator, save_model_path):
     # 加载模型
    model = load_model('results/knn1.h5')
...
def main():
    ...
    :return:
    """
    data_path = "C:\\Users\\yangjuncai\\Desktop\\毕业设计文献\\Computer-vision-based-on-deep-learning-garbage-classification-master\\dataset-resized"  # 数据集路径
    save_model_path = 'C:\\Users\\yangjuncai\\Desktop\\毕业设计文献\\Computer-vision-based-on-deep-learning-garbage-classification-master\\results\\knn1.h5'  # 保存模型路径和名称
    # 获取数据
